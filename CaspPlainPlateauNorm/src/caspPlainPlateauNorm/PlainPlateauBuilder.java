...
public class PlainPlateauBuilder implements ContextBuilder<Object>
{
	...
	{
		String scenarioFileName = "casp-config/plainplateaunorm/scenarios/institution/plainplateauScenario.json ";
		...
		context.setId("CaspPlainPlateauNorm");
		...
		if (Log.getErrorCount() > 0)
			...
			Log.info("Casp PlainPlateauNorm Scenario is Ready");
		return context;
